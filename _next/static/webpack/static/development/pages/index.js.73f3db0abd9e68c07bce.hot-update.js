...
function AllSkillsDisplay(properties) {
  ...
  }, __jsx(_Label__WEBPACK_IMPORTED_MODULE_1__["Label"], null, "Comp\xE9tences (Expertise)"), skills.entries.map(renderSkill.bind(undefined, properties.value.updates, properties.onSelect))), __jsx("div", {
    className: "col-12 d-block d-lg-none"
  }, __jsx("br", null)), __jsx("div", {
    className: "col-12 col-md-6 col-lg"
  }, __jsx(_Label__WEBPACK_IMPORTED_MODULE_1__["Label"], null, "Comp\xE9tences (D\xE9faut)"), defaultSkills.entries.slice(0, defaultSkills.entries.size >> 1).map(renderSkill.bind(undefined, properties.value.updates, properties.onSelect))), __jsx("div", {
    className: "col-12 col-md-6 col-lg"
  }, __jsx(_Label__WEBPACK_IMPORTED_MODULE_1__["Label"], {
    className: "d-none d-md-flex"
  }, "Comp\xE9tences (D\xE9faut)"), defaultSkills.entries.slice(defaultSkills.entries.size >> 1).map(renderSkill.bind(undefined, properties.value.updates, properties.onSelect)))));
}
/**
 * 
 */
...
//# sourceMappingURL=index.js.73f3db0abd9e68c07bce.hot-update.js.map