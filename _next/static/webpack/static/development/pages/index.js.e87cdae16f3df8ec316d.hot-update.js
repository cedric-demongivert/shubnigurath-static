    ...
    value: function levelup() {
      if (this.updates.entries.size > 0) {
        ...
        for (var toUpdateIndex = 0; toUpdateIndex < skillsToUpdate.size; ++toUpdateIndex) {
          ...
          while (_Skill__WEBPACK_IMPORTED_MODULE_10__["Skill"].compare(oldSkills.get(skillsIndex).left, currentSkillToUpdate) < 0) {
            nextSkills.push(oldSkills.get(skillsIndex));
          }

          if (_Skill__WEBPACK_IMPORTED_MODULE_10__["Skill"].compare(oldSkills.get(skillsIndex).left, currentSkillToUpdate) === 0) {}
        }
      } else {
        return this;
      }
...
//# sourceMappingURL=index.js.e87cdae16f3df8ec316d.hot-update.js.map